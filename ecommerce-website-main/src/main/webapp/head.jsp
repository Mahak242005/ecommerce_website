...
<style>
       ...
       <%
        ...
        %>
             ...
             <div class="container-fluid" >
                ...
                <div class="col-md-3">
            <p style="font-size:40px;font-weight:bolder;font-style:normal;font-family:cursive;padding-left:1%"><a href="home.jsp" style="text-decoration: none;color:white">Mahak Interiors</a></p>
           </div>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <%
          if(session.getAttribute("A1")!=null && ((String)session.getAttribute("A1")).equalsIgnoreCase("admin@mahakinteriors.com"))
                {
      %>
