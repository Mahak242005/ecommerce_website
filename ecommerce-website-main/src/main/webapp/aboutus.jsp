...
<html>
   ...
   <div class="row" >
      <div class="col-md-6 col-md-offset-3" style="margin-top: -40px" >
       ...
       <div class="well">
         Mahak Interiors is an interior designing and furnishing company. We provide you with a wide range of choices which best fits your interior designing and furnishing requirements.
       </div>
      </div>
    </div>
    </body>
